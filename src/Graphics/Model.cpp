...
namespace Enigma
{
	...
	*/
	...
	void Model::readNodeHierarchy(const aiNode* node, const aiMatrix4x4& parentTransform, float animationTime, const aiAnimation* anim) {
		...
		for (uint32_t i = 0; i < node->mNumChildren; i++) {
			readNodeHierarchy(node->mChildren[i], globalTransform, animationTime, anim);
		}
	}
