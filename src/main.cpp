...
int main() {
    ...
    world.Enemies.push_back(new Enigma::Enemy("../resources/zombie_walk_test_gltf/scene.gltf", context, ENIGMA_LOAD_ASSIMP_FILE, glm::vec3(60.f, 0.1f, 0.f), glm::vec3(20.f, 20.f, 20.f), 0, 180, 0));
    //world.Enemies.push_back(new Enigma::Enemy("../resources/zombie-walk-test/source/ZombieWalk.fbx", context, ENIGMA_LOAD_ASSIMP_FILE, glm::vec3(60.f, 0.1f, 0.f), glm::vec3(20.f, 20.f, 20.f), 0, 180, 0));
    ...
    world.player->addEquipment(new Enigma::Equipment(glm::vec3(0.f, 13.f, 0.f), new Enigma::Model("../resources/gun.obj", context, ENIGMA_LOAD_OBJ_FILE)));
    ...
    while (!glfwWindowShouldClose(window.window)) {
        ...
        world.Enemies[0]->model->updateAnimation2(timer->current,0);
        //world.Enemies[0]->model->updateAnimation(world.Enemies[0]->model->m_Scene, timer->deltaTime);
        timer->Update();
