...
namespace Enigma
{
	Renderer::Renderer(const VulkanContext& context, VulkanWindow& window, Camera* camera, World* world) : context{ context }, window{ window }, camera{ camera }, m_World{ world } {
		...
		m_animPipeline = CreateGraphicsPipeline("../resources/Shaders/vertexAnim.vert.spv", "../resources/Shaders/fragment.frag.spv", VK_FALSE, VK_TRUE, VK_TRUE, { Enigma::sceneDescriptorLayout, Enigma::descriptorLayoutModel }, m_pipelinePipelineLayout, VK_PRIMITIVE_TOPOLOGY_LINE_STRIP, context, window);
