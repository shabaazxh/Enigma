...
bool CollisionDetector::CheckCollision(const Model& character, const std::vector<Model>& environment) {
...
bool CollisionDetector::AABBvsAABB(const Model& obj1, const Model& obj2) {
